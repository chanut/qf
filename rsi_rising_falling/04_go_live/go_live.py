...
strategy.live_set_indicator(ind_set_index=2)
strategy.log_indicator_settings(ind_set_index=2)
...
log_dynamic_order_settings(dos_index=47, dynamic_order_settings=dynamic_order_settings)
